    ...
    override fun onMethodCall(call: MethodCall, rawResult: MethodChannel.Result) {
        ...
        when (method) {
            ...
            "custom" -> {
                ...
                Log.d(
                    FilePickerPlugin.TAG,
                    "allowedExtensions:" + allowedExtensions?.joinToString(",")
                    + ",arguments.allowedExtensions:" + (arguments?.get("allowedExtensions") as ArrayList<String>?)?.joinToString(",")
                )
